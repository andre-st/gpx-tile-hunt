...
_Fig: Visited tiles of (configurable) 1,5 km² fixed size at different map zoom levels_
...
- Usage:
	```sh
		...
		$ ./gpx2kml.py   # Generates tile mesh KML file from ./routes/*.gpx ; see --help too
...
- Pro & Cons:
	- ...
- Alternative:
	- Komoot: create a _collection_ and add _all_ existing tours to it, then examine the collection's map 
		(might be sluggish and perhaps limited number of tours)
	- Pay and maintain a Strava account
	- ...
